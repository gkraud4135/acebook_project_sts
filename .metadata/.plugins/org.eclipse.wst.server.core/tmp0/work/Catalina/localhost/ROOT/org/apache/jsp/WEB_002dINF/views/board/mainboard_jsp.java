 ...
 * Generated at: 2021-08-28 13:54:22 UTC
...
Member member = (Member)request.getAttribute("member"); 
      ...
      out.write("\t                \t\t\t\t+item.wdate+\"<br>박스번호: box\"+size+\" 게시물번호:\"+item.sn+\"<div class=box\"+item.sn+\">\"+\"</div>\"+\"<div class=like\"+item.sn+\">\"+\"</div>\"+\"<input type=\\\"button\\\" onclick=\\\"댓글(\"+item.sn+\",\"+");
      out.print(member.getProfile());
      out.write("+\",0)\\\" class=\\\"comments\"+item.sn+\"\\\" value=\\\"댓글\\\" /><div class=\\\"comment\"+item.sn+\"\\\">\"+\"</div><div id=photo\"+item.sn+\">\"+\"</div>\"+'</div>');\t                \t\t\r\n");
